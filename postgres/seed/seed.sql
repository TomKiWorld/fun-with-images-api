...
insert into users (name, email, entries, avatar, joined) values ('Visitor', 'visitor@gmail.com', 9, 'avatarOne', '2020-05-24');
...
insert into users (name, email, entries, avatar, joined) values ('Tester', 'tester@gmail.com', 2, 'avatarTwo', '2020-05-24');
